module Bridge::BCSUtils {
    ...
    public fun peel_vec_u8(_bcs: &mut vector<u8>): vector<u8> {
        // TODO(VR): Add implementation code
        Vector::empty<u8>()
    }

    public fun peel_bool(_bcs: &mut vector<u8>): bool {
        // TODO(VR): Add implementation code
        false
    }

    public fun peel_vec_u64(_bcs: &mut vector<u8>): vector<u64> {
        // TODO(VR): Add implementation code
        Vector::empty<u64>()
    }

    public fun peel_vec_vec_u8(_bcs: &mut vector<u8>): vector<vector<u8>> {
        // TODO(VR): Add implementation code
        Vector::empty<vector<u8>>()
    }


    public fun into_remainder_bytes(_bcs: &vector<u8>): vector<u8> {
        // TODO(VR): Add implementation code
        Vector::empty<u8>()
    }
