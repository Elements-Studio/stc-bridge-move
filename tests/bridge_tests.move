...
//     let mut env = create_env(ChainIDs::starcoin_testnet());
...
//     let mut env = create_env(ChainIDs::sui_mainnet());
...
//     env.send_token(@0xABCD, ChainIDs::eth_sepolia(), eth_address, btc);
//     env.destroy_env();
// }
//
...
//     let eth_address = x"0000000000000000000000000000000000000000";
//     env.send_token(@0x0, ChainIDs::eth_sepolia(), eth_address, btc);
//
//     abort TEST_DONE
// }
//
...
//     env.send_token(val_addr, ChainIDs::eth_sepolia(), eth_address, btc);
//
//     abort TEST_DONE
// }
//
...
//     env.send_token(@0xAAAA, ChainIDs::eth_sepolia(), eth_address, eth);
//
//     abort TEST_DONE
// }
//
...
//     let eth_address = x"0000000000000000000000000000000000000000";
//     env.send_token(@0xABCDEF, ChainIDs::eth_mainnet(), eth_address, usdc);
//
//     abort TEST_DONE
// }
//
...
//     let mut env = create_env(ChainIDs::starcoin_testnet());
//     env.create_bridge_default();
//     env.execute_blocklist(sender, ChainIDs::sui_mainnet(), 0, vector[]);
//
//     abort TEST_DONE
// }
//
...
//     let chain_id = ChainIDs::sui_mainnet();
//     let mut env = create_env(chain_id);
//     env.create_bridge_default();
//
//     let bridge = env.bridge(@0x0);
